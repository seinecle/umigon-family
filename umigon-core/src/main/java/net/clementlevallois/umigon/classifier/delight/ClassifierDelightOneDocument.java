...
public class ClassifierDelightOneDocument {

    Semantics semantics;
    LoaderOfLexiconsAndConditionalExpressions lexiconsAndTheirConditionalExpressions;

    public ClassifierDelightOneDocument(Semantics semantics) {
...
//        }
        ...
        for (SentenceLike sentenceLikeFragment : listOfSentenceLikeFragments) {
            ...
            for (NGram ngram : sentenceLikeFragment.getNgrams()) {
                ...
                ----- 3 -----
            Checking if the ngram matches a heuristic for DELIGHT TERMS
            
            (mapH17 lists delight terms and their rules)
